...
movie::movie(std::string name, std::string id, int timestamp,
...
actor_pair::actor_pair(std::string actor_id1, std::string actor_id2,
                       int number_movies) {
...
std::string actor_pair::get_info() {
  std::string result = "(" + actor_id1 + " " + actor_id2 + " " +
                       std::to_string(number_movies) + ")";
  return result;
}
